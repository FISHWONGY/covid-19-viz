...
with open('/Volumes/My Passport for Mac/R/convid-19/15 May 20/nytimes/nytdata.csv') as f:
...
with open('/Volumes/My Passport for Mac/R/convid-19/15 May 20/nytimes/data.csv', 'w') as f:
...
nytdata <- suppressWarnings(read_csv(
  "/Volumes/My Passport for Mac/R/convid-19/15 May 20/nytimes/data.csv", na = "NULL"))
```
...
```{r}
ww / usa +
   ggsave("/Volumes/My Passport for Mac/R/convid-19/15 May 20/photo/WkendDea_patch.png", dpi = 320, width = 10.8, height = 12)
```
